...
var pespProjMatrix3 = new Matrix4();
...
function main(){
    ...
    pespProjMatrix3.setOrtho(-2,2,-2,2,-100,100);
...
function mouseMove(ev){ 
    ...
    drawOneViewport(gl, 0, 0, canvas.width/2, canvas.height/2,
                    0, 0, 0,
                    pespProjMatrix1, frontViewMatrix, modelMatrix1, modelMatrix2 );

    drawOneViewport(gl, 0, 200, canvas.width, canvas.height/2,
                    0.6, 0.6, 0.6,
                    pespProjMatrix2, BackViewMatrix, modelMatrix1, modelMatrix2 );

    drawOneViewport(gl, 200, 0, canvas.width/2, canvas.height/2,
                    0.3, 0.3, 0.3,
                    pespProjMatrix3, frontViewMatrix, modelMatrix1, modelMatrix2 );
